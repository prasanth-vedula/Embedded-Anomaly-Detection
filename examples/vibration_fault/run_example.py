"""Run the vibration-fault TinyML anomaly-detection demonstration."""
...
def main() -> int:
    result = evaluate()
    scenario = result["scenarios"]["vibration_fault"]

    output = {
        "scenario": "vibration_fault",
        ...
        "expected_behavior": "elevated reconstruction error from vibration disturbance",
    }
