"""Run the current-fault TinyML anomaly-detection demonstration."""
...
def main() -> int:
    result = evaluate()
    scenario = result["scenarios"]["current_fault"]

    output = {
        "scenario": "current_fault",
        ...
        "expected_behavior": "elevated reconstruction error from current disturbance",
    }
