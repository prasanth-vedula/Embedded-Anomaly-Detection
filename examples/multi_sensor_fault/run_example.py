"""Run the multi-sensor-fault TinyML anomaly-detection demonstration."""
...
def main() -> int:
    result = evaluate()
    scenario = result["scenarios"]["multi_sensor_fault"]

    output = {
        "scenario": "multi_sensor_fault",
        ...
        "expected_behavior": "strong reconstruction error from simultaneous sensor disturbances",
    }
